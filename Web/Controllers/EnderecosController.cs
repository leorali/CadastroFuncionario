...
namespace Web.Controllers
{
    public class EnderecosController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Logradouro,Cep,Complemento")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Logradouro,Cep,Complemento")] Endereco endereco)
        {
            if (ModelState.IsValid)
            {
